"""
Django settings for prd_demo_dylan_45505 project.
...
ROOT_URLCONF = 'prd_demo_dylan_45505.urls'
...
WSGI_APPLICATION = 'prd_demo_dylan_45505.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_demo_dylan_45505 API",
    "DESCRIPTION": "API documentation for prd_demo_dylan_45505 App",
    "VERSION": "v1",
}
